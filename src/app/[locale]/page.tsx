...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    comment:
      "Maveraone made our honeymoon unforgettable! The booking process was seamless, and the hotel recommendations were spot on. Highly recommended!",
  },
  {
    id: 2,
    name: "Emma Smith",
    ...
    rating: 5,
    comment:
      "I was nervous about traveling solo, but the support team was there 24/7. The group tour to Kyoto was organized perfectly. I made friends for life.",
  },
  {
    id: 3,
    name: "Michael Ross",
    ...
    rating: 4.5,
    comment:
      "Great prices and amazing destinations. The Swiss Alps package was a dream come true. Will definitely book my next summer vacation here.",
  },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "We accept all major credit cards (Visa, MasterCard, American Express), PayPal, and direct bank transfers. All transactions are secured with industry-standard encryption.",
  },
  {
    question: "Can I cancel or modify my booking?",
    answer:
      "Yes, modifications can be made up to 14 days before your trip. Cancellations made 30 days in advance are eligible for a full refund. Please check specific tour policies as they may vary.",
  },
  {
    question: "Is travel insurance included?",
    answer:
      "Basic travel insurance is included in some premium packages. For standard bookings, we highly recommend purchasing comprehensive travel insurance separately to cover medical emergencies and trip interruptions.",
  },
  {
    question: "Do you offer group discounts?",
    answer:
      "Yes! We offer special rates for groups of 10 or more. Please contact our support team with your group details to get a customized quote.",
  },
];
          ...
          <div className="flex flex-col items-center justify-center flex-1 px-4 md:px-10 pb-10 z-10 w-full max-w-[1400px] mx-auto">
            <div className="flex flex-col gap-5 text-center max-w-[850px]">
              ...
              <motion.h2
                ...
                className="text-white/90 text-lg md:text-xl font-medium drop-shadow-md max-w-xl mx-auto"
              >
                {t("hero.subtitle")}
              </motion.h2>
            </div>
                    ...
                    <Link key={tour.id} href={getLocalizedPath(`/tours/${tour.id}`)}>
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-1">
                          <h3 className="text-[#111418] text-lg font-bold leading-tight group-hover:text-[#137fec] transition-colors">
                            {tour.title}
                          </h3>
                          <p className="text-[#617589] text-sm font-normal">
                            {tour.duration} Days &bull; From $
              ...
              >
                {TESTIMONIALS.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <p className="text-[#111418] text-base leading-relaxed">
                      &ldquo;{testimonial.comment}&rdquo;
                    </p>
                    <div className="flex items-center gap-3 mt-auto pt-4">
                      <div
                        className={`w-10 h-10 rounded-full ${testimonial.bgColor} flex items-center justify-center ${testimonial.textColor} font-bold text-sm`}
                      >
                        {testimonial.initials}
                      </div>
                      <div>
                        <p className="text-[#111418] text-sm font-bold">
                          {testimonial.name}
                        </p>
            ...
            >
              <div className="text-center mb-10">
                ...
                <p className="text-[#617589] mt-2">
                  Everything you need to know about booking with Maveraone
                </p>
              </div>
              <motion.div
                initial="hidden"
              ...
              >
                ...
                >
                  ...
                  <p className="text-[#617589] text-sm leading-relaxed">
                    We ensure you get the most competitive prices for your tours
                    and stays, matched with quality.
                  </p>
                </motion.div>
                <motion.div
                  variants={scaleUpVariants}
                ...
                >
                  ...
                  <p className="text-[#617589] text-sm leading-relaxed">
                    We strictly vet all our accommodation partners to ensure
                    comfort, safety, and unique experiences.
                  </p>
                </motion.div>
              </motion.div>
            </motion.div>
              ...
              <div className="flex-1 p-8 md:p-12 flex flex-col justify-center gap-6">
                ...
                >
                  ...
                  <p className="text-white/80 text-base">
                    Sign up to our newsletter for travel tips, personalized
                    itineraries, and exclusive vacation deals.
                  </p>
                </motion.div>
                <motion.div
